...
# NOTE: Leaderboard computation is now handled by rebuild_politician_stats()
# in performance.py, which imports and uses _run_simulation from this module.
# This ensures the leaderboard and profile pages use the exact same engine.
